...
import '../modules/ketentuan_privasi/bindings/ketentuan_privasi_binding.dart';
import '../modules/ketentuan_privasi/views/ketentuan_privasi_view.dart';
...
import '../modules/pembayaran2/bindings/pembayaran2_binding.dart';
import '../modules/pembayaran2/views/pembayaran2_view.dart';
import '../modules/pencarian/bindings/pencarian_binding.dart';
import '../modules/pencarian/views/pencarian_view.dart';
import '../modules/pesan_tukang/bindings/pesan_tukang_binding.dart';
import '../modules/pesan_tukang/views/pesan_tukang_view.dart';
import '../modules/profile_page/bindings/profile_page_binding.dart';
import '../modules/profile_page/views/profile_page_view.dart';
import '../modules/register/bindings/register_binding.dart';
import '../modules/register/views/register_view.dart';
import '../modules/spalsh_screen0/bindings/spalsh_screen0_binding.dart';
import '../modules/spalsh_screen0/views/spalsh_screen0_view.dart';
...
class AppPages {
  ...
  static const INITIAL = Routes.SPALSH_SCREEN0;
  ...
  static final routes = [
    ...
    GetPage(
      name: _Paths.SPALSH_SCREEN0,
      page: () => const SpalshScreen0View(),
      binding: SpalshScreen0Binding(),
    ),
  ];
}
